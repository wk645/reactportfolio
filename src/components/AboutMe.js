	...
	return (
		<Message className="bio">
			...
			<p>
				...
				<br />
				<br />
				Immediately following graduation, I was accpeted into the Flatiron School's, recently acquired by WeWork, immersive Full Stack Software Engineering program, which concentrated on JavaScript, Ruby, Ruby on Rails, React.js, and more. I built many projects in groups and also individually. Since graduation, I studied React Native, and have been studying Python. 
				<br />
				<br />
				...
				<li>I absolutely love traveling. I've traveled to 13 countries, and more to come!</li>
			</p>

			<Image src='https://yt3.ggpht.com/-RZYi5isxH_M/AAAAAAAAAAI/AAAAAAAAAAA/rmWpoe2qZzI/s900-c-k-no-mo-rj-c0xffffff/photo.jpg' className='bioPic1' shape='circular' />
			<Image src='http://blog.flatironschool.com/wp-content/uploads/2017/10/WWxFIS-352x200.png' className='bioPic2' shape='circular' />
		</Message>
	)
}
